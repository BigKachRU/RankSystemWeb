...
namespace RankingApp.Controllers
{
    ...
    public class ItemController : ControllerBase
    {
        ...
        {
            new ItemModel{Id =1, Title = "Cheburashka", ImageId=1, Ranking=0,ItemType=1 },
            new ItemModel{Id =2, Title = "Fortuna", ImageId=2, Ranking=0,ItemType=1 },
            new ItemModel{Id =3, Title = "Top Gun", ImageId=3, Ranking=0,ItemType=1 },
            new ItemModel{Id =4, Title = "The Covenant", ImageId=4, Ranking=0,ItemType=1 },
